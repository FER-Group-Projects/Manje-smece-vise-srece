...
\end{minted}
			...
			\noindent \textbf{Ispitni slučaj \thetestcase: Komentiranje i ocjenjivanje kontejnera} \\
			\noindent \textbf{Ulaz:}
			\begin{packed_enum}
				\item Otvaranje početne stranice u web pregledniku te prijava u sustav\footnotemark.
				...
				\item Upisivanje komentara kontejnera, ocjenjivanje komentara i pritisak na ikonu diskete.
				\item Odjava iz sustava\footnotemark[\value{footnote}].
