...
\end{minted}
				...
				\label{test3}
			\end{listing}
			\noindent \textbf{Rezultat:} Očekivani rezultat je zadovoljen. Ocjena i komentar su pohranjeni.
...
\end{minted}
		...
		\section{Upute za puštanje u pogon}
			 ...
			 % \textit{Dovršenu aplikaciju potrebno je pokrenuti na javno dostupnom poslužitelju. Studentima se preporuča korištenje neke od sljedećih besplatnih usluga: \href{https://aws.amazon.com/}{Amazon AWS}, \href{https://azure.microsoft.com/en-us/}{Microsoft Azure} ili \href{https://www.heroku.com/}{Heroku}. Mobilne aplikacije trebaju biti objavljene na F-Droid, Google Play ili Amazon App trgovini.}
		   	...
		   	\begin{packed_enum}
		            ...
		            \item \textbf{Konfiguracija \textit{pom.xml} i \textit{application.properties} datoteka}
		                \begin{packed_item}
                			\item {U pom.xml potrebno je dodati:} 
                			    \begin{figure}[H]
            					\includegraphics[scale=0.7]{dokumentacija/slike/backend/pompostgres.png}
            					\centering
                			...
                			\item {U application.properties potrebno je dodati:}
                			    \begin{figure}[H]
            					\includegraphics[scale=0.8]{dokumentacija/slike/backend/propertiesdb.png}
            					\centering
    		      ...
    		      \item \textbf{Pozicioniranje u radni direktorij backend-a putem cmd terminala}
    		            \begin{figure}[H]
    					\includegraphics[scale=1]{dokumentacija/slike/backend/backendposition.png}
    					\centering
    		      ...
    		      \item \textbf{mvn install}
    		            \begin{figure}[H]
    					\includegraphics[scale=0.9]{dokumentacija/slike/backend/backendinstall.png}
    					\centering
    					\caption{mvn install}
    		      ...
    		      \item \textbf{mvn package}
    		            \begin{figure}[H]
    					\includegraphics[scale=0.9]{dokumentacija/slike/backend/backendpackage.png}
    					\centering
    					\caption{mvn package}
    		      ...
    		      \item \textbf{java -jar target/manje-smece-vise-srece-backend-0.0.1-SNAPSHOT.jar}
    		            \begin{figure}[H]
    					\includegraphics[scale=0.9]{dokumentacija/slike/backend/backendjar.png}
    					\centering
    					\caption{Pokretanje}
		   	...
		   	\noindent \underbar{\textbf{Frontend:}}
    		      ...
    		      \end{packed_item}
    					...
    					\begin{figure}[H]
    					\includegraphics[scale=1]{dokumentacija/slike/backend/proxy.png}
    					\centering
    					\caption{proxy}
    					\label{fig:proxy}
    		            \end{figure}
            ...
            \item \textbf{npm start}
    		            \begin{figure}[H]
    					\includegraphics[scale=0.8]{dokumentacija/slike/frontend/treca.jpg}
    					\centering
    					\caption{npm start}
    					\label{fig:npm start}
    		            \end{figure}
    		            ...
    		            \begin{figure}[H]
    					\includegraphics[scale=0.40]{dokumentacija/slike/frontend/cetvrta.png}
    					\centering
    					\caption{Konačno}
    					\label{fig:konacno}
    		            \end{figure}
