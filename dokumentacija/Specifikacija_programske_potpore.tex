\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\noindent {\textbf{U3 - Registracija}}
			
			\noindent Neregistrirani korisnik upisuje podatke za registraciju u formu. Ti podatci su korisničko ime, email i password, ako se korisničko ime ili email već koristi web aplikacija će naznačiti da nije moguće korištenje već iskorištenih podataka. Ako podatci nisu zauzeti aplikacija vraća novog korisnika na glavnu stranicu
			...
			\begin{figure}
				\centering
				\includegraphics[width=1.0\linewidth]{"slike/UC3-seq"}
