\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{figure}
				...
				\caption{Sekvencijski dijagram za pretraživanje i pregled kontejnera putem ID-a}
				\label{fig:UC1-Seq}
			\end{figure}
			...
			\begin{figure}
				...
				\caption{Sekvencijski dijagram za komentiranje kontejnera}
				\label{fig:UC8-Seq}
			\end{figure}
			...
			\noindent {\textbf{Obrazac uporabe UC1 - Dodavanje korisnika}}
			...
			\clearpage	 
			\noindent {\textbf{Obrazac uporabe UC5 - Premještanje kontejnera}}
