\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
			...
			\noindent \underbar{\textbf{UC5 - Dodavanje  korisnika}}
			\begin{packed_item}
			...
			\noindent \underbar{\textbf{UC6 - Brisanje  korisnika}}
			\begin{packed_item}
			...
			\noindent \underbar{\textbf{UC7 - Dodavanje  kontejnera}}
			\begin{packed_item}
			...
			\noindent \underbar{\textbf{UC8 - Brisanje  kontejnera}}
			\begin{packed_item}
			...
			\noindent \underbar{\textbf{UC9 - Premještanje  kontejnera}}
			\begin{packed_item}
