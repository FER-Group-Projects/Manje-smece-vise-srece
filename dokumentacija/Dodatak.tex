\chapter*{Dodatak: Prikaz aktivnosti grupe}
		...
		\newcommand{\imenaClanova}{A.Novak, F.Vale, I.Teofilović, M.Benotić, M.Lazarić, P.Jakopec, R.Pavliš}
		
		\begin{packed_enum}
			\item  sastanak
			\item[] \begin{packed_item}
				\item Datum: 17. listopada 2019.
				\item Prisustvovali: \imenaClanova
				\item Teme sastanka:
				\begin{packed_item}
		...
		\section*{Tablica aktivnosti}
			...
			\begin{longtabu} to \textwidth {|X[7, l]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|}
				...
				Upravljanje projektom 		& 6 & 5 & 5 & 5 & 5 & 5 & 5 \\ \hline
				Opis projektnog zadatka 	&  & 1 & 1 &  &  & 2 &  \\ \hline
